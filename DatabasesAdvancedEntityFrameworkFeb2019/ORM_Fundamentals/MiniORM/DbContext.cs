namespace MiniORM
{
    ...
    public abstract class DbContext
    {
            ...
            where TCollection : class, new()
        {
            ...
            var foreighKey = entityType.GetProperties()
            ...
            {
                var primaryKeyValue = foreighKey.GetValue(entity);
            ...
            where TEntity : class, new()
        {
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                var navigationPriparyKey = navigationProperty.PropertyType.GetProperties()
                    .First(pi => pi.HasAttribute<KeyAttribute>());
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPropertyValue = ((IEnumerable<object>)navigationDbSet)
                        .First(currentNavigationProperty => navigationPriparyKey.GetValue(currentNavigationProperty).Equals(foreignKeyValue));
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var columns = table.GetProperties()
                ...
                !pi.HasAttribute<NotMappedAttribute>() && AllowedSqlTypes.Contains(pi.PropertyType))
                .Select(pi => pi.Name)
                .ToArray();
