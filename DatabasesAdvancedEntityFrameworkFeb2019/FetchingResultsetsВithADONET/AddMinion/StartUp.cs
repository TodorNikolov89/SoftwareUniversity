    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                int minionId = GetiMinionsByName(connection, minionName);
        ...
        private static int GetiMinionsByName(SqlConnection connection, string minionName)
        {
        ...
        private static void AddMinion(SqlConnection connection, string minionName, int age, int? id)
        {
